...
const policyOptions = ['DefaultAlgorithm', 'WeightedAlgorithm'];
...
class WeightedAlgorithm extends React.Component {
    ...
    if (props.previousPolicy && props.previousPolicy.class === 'WeightedAlgorithm') {
      this.state = {
        weights: Object.assign(
          {},
          ...props.previousPolicy.weights.map(weight => ({
            [weight.algorithmId]: weight.weight,
          })),
        ),
      };
    } else {
  ...
  render() {
    ...
    return <div>{algorithmComponents}</div>;
  }
}
          ...
          <div className="policySettings">
            ...
            {this.state.policyClass === 'DefaultAlgorithm' && (
              <DefaultAlgorithm
                ...
                previousPolicy={this.props.policy}
